...
class TestMethods(invoke_filter):
    def test_get_id():
        assert filter_class.get_id(entry) == "PYSEC-2014-8"
    ...
    def test_get_description():
        ...
        assert filter_class.get_description(entry) == description

    def test_get_aliases():
        assert filter_class.get_aliases(entry) == ["CVE-2014-1402"]
    ...
    def test_get_affected_versions():
        ...
        assert filter_class.get_affected_versions(entry) == versions
    ...
    def test_get_references():
        ...
        assert filter_class.get_references(entry) == references
